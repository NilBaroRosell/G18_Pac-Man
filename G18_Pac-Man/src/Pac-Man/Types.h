...
enum SceneStates { WAITING_SPLASH, MENU_SPLASH, WAITING_MENU, PLAY_MENU, RANKING_MENU, EXIT_MENU, START_GAME_PLAY, RUNNING_PLAY, PAUSED_PLAY, GET_NAME_PLAY, GAME_OVER_PLAY , WAITING_RANKING, BACK_RANKING };
